...
本站点使用基于[Astro](https://docs.astro.build/zh-cn/getting-started/)框架的主题[Fuwari](https://github.com/saicaca/fuwari)部署
...
一个从初中开始就喜欢捣鼓电脑和其他一些新奇的技术，~~虽然没啥卵用~~。:spoiler[曾在校级大会上匿名点名过,这TM有什么好骄傲的。]平时喜欢用DAW（数字音频工作站）扒一些喜欢的歌，如果有人感兴趣，我也会考虑在博客里写一些

## 名字由来

为什么起这个名字： [kian](https://www.namechef.co/cn/kian-name-meaning/) 这个单词是我从大一的时候在网上查的爱尔兰语的单词，觉得它和我真名里面有个字谐音，我就用了。但一开始我的网名不是这个，是GRandXZJ，这个名字是由两部分组成的，`GR`和`XZJ`,前半部分是来源一个钥匙挂扣，[点我看参考图](https://ts1.tc.mm.bing.net/th/id/OIP-C.PlrkgWSCA8H0luBhYx298QHaHa?rs=1&pid=ImgDetMain&o=7&rm=3)。把它打开真的很像`G`和`R`两个字母的组合；后半部分是我名字的缩写，于是这个名字就诞生了。前面`GRand`还阴差阳错的和一个单词`Grand`撞上了。在查到这个爱尔兰语单词后觉得单纯用名字拼音缩写太草率了，改为了`GrandKian`,然后简称`Kian`了
...
这个博客是用来记录我日常工作或者学习中觉得有意思的技术分享。可能更新的不是很频繁，也可能只有我一个人会来看这个网站，没关系，只要我还在，这个博客就是我最好的日记本。
...
[SakuraVillager-樱花庄驿](https://blog.jijiz.cn/),我是跟着它里面的文章一步一步把自己的博客复活的，非常感谢能让我再次拥有了我的博客
